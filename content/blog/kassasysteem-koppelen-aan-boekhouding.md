...
Maar niet elke koppeling werkt even soepel. De kwaliteit verschilt per combinatie van kassasysteem en boekhoudpakket, en een slecht ingerichte koppeling kan meer fouten introduceren dan handmatige invoer. Dit artikel beschrijft hoe de koppeling in de praktijk werkt, welke combinaties goed samenwerken en waar je op moet letten.
...
Tweede fout: de koppeling te laat instellen en maanden aan historische data handmatig proberen in te voeren. Stel de koppeling in vanaf dag één van gebruik, of aan het begin van een nieuw boekjaar. Retroactief importeren is tijdrovend en foutgevoelig.
