...
faq:
  ...
  - q: "Wat kosten CRM-integraties?"
    a: "Ingebouwde integraties zijn meestal inbegrepen in het CRM-abonnement. Sommige geavanceerde koppelingen vereisen een hoger abonnementsniveau. Als je een integratieplatform als Zapier nodig hebt, kost dat extra: Zapier begint vanaf €20 per maand voor eenvoudige workflows. Een maatwerkkoppeling via een developer is aanzienlijk duurder en is alleen zinvol als er geen standaardoplossing beschikbaar is. Reken alle integratiekosten mee in je totale CRM-budget."
...
Ik heb een bedrijf geholpen dat vijf losse tools gebruikte zonder koppeling — ze verloren gemiddeld twee uur per dag aan handmatig data overzetten. Na het inrichten van drie basisintegraties was dat teruggebracht naar minder dan tien minuten. Dat is het verschil dat goede koppelingen maken.
...
De meeste moderne CRM's -- HubSpot, Pipedrive, Salesforce -- hebben directe plugins voor Gmail en Outlook. Controleer of de synchronisatie bidirectioneel werkt: niet alleen inkomende e-mail maar ook uitgaande. En controleer of bijlagen in het CRM worden opgeslagen of alleen de tekst. Ik adviseer altijd om de e-mailintegratie als eerste te activeren, nog vóór je collega's het systeem opent — zo staat er al data in als ze inloggen.

**Kalenderintegratie** zorgt dat afspraken die je plant in Google Calendar of Outlook direct zichtbaar zijn in het CRM-contactprofiel. Voor [SaaS-startups](/sectoren/crm/crm-voor-saas-startups/) met veel demo-calls is dit bepalend: een verkoper ziet in één oogopslag alle geplande sessies en kan direct zien welke leads al een demo hebben gehad en welke nog niet.
...
Bereken wat deze integraties concreet opleveren voor jouw situatie met de [CRM ROI berekenen tool](/tools/crm/roi-berekenen/).
...
Controleer na de eerste twee weken of de integratie foutloos werkt. Loop een steekproef van twintig contacten door en controleer of de gesynchroniseerde data klopt. Als er afwijkingen zijn, los die op voor je het systeem volledig vertrouwt. Ik voer deze steekproef standaard uit bij elke klant — en ik heb er nog nooit één zonder een kleine afwijking gevonden. Beter vroeg opsporen dan drie maanden later.
