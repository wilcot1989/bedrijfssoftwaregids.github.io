...
faq:
  ...
  - q: "Hoe verwerk ik trial-gebruikers in een CRM als SaaS-bedrijf?"
    a: "Koppel je product via de API aan je CRM zodat trial-aanmeldingen automatisch als contactrecord of deal worden aangemaakt. In HubSpot kun je deal-stages aanpassen aan je funnel: trial, geactiveerd, betaald. Salesforce laat je custom objects bouwen voor subscription-data. Pipedrive is hierin minder flexibel."
